      ...
      <View style={styles.container}>
        ...
        >
          <View style={{ flexDirection: "row", margin:10 ,}}>
            <View style={{flex:6 , justifyContent:"flex-end" }} ><Icon name="md-arrow-back" color="#ffffff" size={25} /></View>
            <View style={{flex:1}} ><Icon name="md-create" color="#ffffff" size={25} /></View>
            <View style={{flex:1}}><Icon name="md-refresh" color="#ffffff" size={25} /></View>
          </View>
